...
function getMaxFuel(id)
	if isElement(id) then
		-- If it's a vehicle element, get its model
		id = getElementModel(id)

		-- If it's a custom model, get the base model for fuel calculations
		if exports.vehicle:isCustomVehicleModel(id) then
			id = exports.vehicle:getVehicleBaseModel(id)
		end
	end
