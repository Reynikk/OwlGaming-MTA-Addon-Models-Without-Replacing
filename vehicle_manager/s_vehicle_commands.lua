...
function createTempVehicle(thePlayer, commandName, vehShopID)
	if exports["integration"]:isPlayerTrialAdmin(thePlayer) or exports.integration:isPlayerScripter(thePlayer) then
		...
		local veh = exports.vehicle:createVehicleWithCustomModel(vehicleID, x, y, z, 0, 0, r, plate)

		if not (veh) then
			outputDebugString("VEHICLE MANAGER / createTempVehicle / FAILED TO CREATE VEHICLE")
			outputChatBox("Ops.. Something went wrong creating the vehicle.", thePlayer, 255, 0, 0)
			return false
		end
		...
		exports.anticheat:setEld( veh, "fuel", exports.vehicle_fuel:getMaxFuel(exports.vehicle:getEffectiveVehicleModel(veh)) )
